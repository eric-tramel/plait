"""Custom exception types for inf-engine.

This module defines the exception hierarchy used throughout inf-engine
...
Example:
    ...
    ...     print("Some other inf-engine error")
"""


class InfEngineError(Exception):
    """Base exception for all inf-engine errors.

    This is the root of the inf-engine exception hierarchy. All custom
    exceptions in inf-engine inherit from this class, allowing users to
    catch all inf-engine errors with a single except clause while still
